...
export const ACTION_MODE_ACTIONS = {
  [ACTION_MODE.BOOKMARKS]: BP_SEARCH_BOOKMARKS,
  [ACTION_MODE.HISTORY]: BP_SEARCH_HISTORIES,
};
...
export const BROWSER_ACTION_URL_MAP: Record<string, string> = {
  ...
  [BP_OPEN_HELP_TAB]: "chrome://help",
  [BP_ABOUT_EXTENSION]: "https://github.com/gnehcwu/tablyt",
};
